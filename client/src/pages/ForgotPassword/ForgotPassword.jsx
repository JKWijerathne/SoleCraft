    ...
    <div className="min-h-screen relative overflow-hidden bg-transparent flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tighter text-[#071A2F] text-center uppercase mb-2">
            ...
            <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-[#F5B942] text-[#071A2F] font-extrabold py-4 rounded-xl hover:bg-[#D99A20] transition-all active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm uppercase tracking-widest shadow-lg shadow-[#F5B942]/25"
                >
                  {status === 'loading' ? (
                    <>

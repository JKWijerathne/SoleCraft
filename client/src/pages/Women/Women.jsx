...
const Women = () => {
  ...
  const filteredProducts = products.filter(product => {
    ...
    if (cat !== 'women' && cat !== 'woman') return false;
    ...
    <div className="min-h-screen bg-[#F8FAFC] pt-8 pb-24 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center md:text-left">
          ...
          >
            Women's <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D99A20] to-[#F5B942]">Collection</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Discover our elegant range of footwear designed exclusively for women. From chic heels to comfortable everyday flats.
          </motion.p>
        </div>

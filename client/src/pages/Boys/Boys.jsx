...
const Boys = () => {
  ...
  const filteredProducts = products.filter(product => {
    ...
    if (cat !== 'boys' && cat !== 'boy') return false;
    ...
    <div className="min-h-screen bg-[#F8FAFC] pt-8 pb-24 px-4 md:px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12 text-center md:text-left">
          ...
          >
            Boys' <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D99A20] to-[#F5B942]">Collection</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Explore our durable and stylish range of footwear for boys. Built for adventure and everyday play.
          </motion.p>
        </div>
